  ...
  return (
    <div>
      <div className="flex flex-col items-center gap-4 justify-center mt-10 ">
        <Logo />
        <h3 className="text-3xl font-semibold w-96 h-72 bg-blueEyes text-white rounded pt-4 ">
      ...
      <table class=" flex flex-col items-center gap-6 ">
        <thead>
          <tr className="flex flex-row gap-10 mt-6 bg-red-300 px-6 rounded">
            <th>ID</th>
            <th>Name</th>
            <th>Position</th>
            <th>Attendance</th>
        ...
        <tbody>
          {
            Object.keys(users).map((key,i)=>{
              return(
                <tr className="flex flex-row gap-10 items-center bg-green-300 px-6 py-4 " key={i}>
                  <td>{users[key].id}</td>
                  <td className="w-16">{users[key].name}</td>
                  <td className="w-16">{users[key].position}</td>
